...
TEST_CASE("TControladorBitParidadePar::adicionarControle") {
  ControladorBitParidadePar controlador_de_erro;
  Quadro quadro;
  quadro.push_back(0);
  quadro.push_back(1);
  quadro.push_back(0);
...
TEST_CASE("TControladorBitParidadePar::control") {
  ControladorBitParidadePar controlador;
  Quadro quadro;
  quadro.push_back(0);
  quadro.push_back(1);
  SECTION("Bit paridade == 1") {
